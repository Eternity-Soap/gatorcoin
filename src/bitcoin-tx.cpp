...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s gatorcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  gatorcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gatorcoin transaction") + "\n" +
              "  gatorcoin-tx [options] -create [commands]   " + _("Create hex-encoded gatorcoin transaction") + "\n" +
              "\n";
