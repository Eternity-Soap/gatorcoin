...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Gatorcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"gatorcointools.com", "dnsseed.gatorcointools.com"},
    {"gatorcoinpool.org", "dnsseed.gatorcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"gatorcointools.com", "testnet-seed.gatorcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Gatorcoin is probably already running."), addrBind.ToString().c_str());
        else
