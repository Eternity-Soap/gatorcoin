...
const char * const BITCOIN_CONF_FILENAME = "gatorcoin.conf";
const char * const BITCOIN_PID_FILENAME = "gatorcoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Gatorcoin";
#else
    // Unix
