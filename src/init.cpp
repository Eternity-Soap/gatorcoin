...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/gatorcoin-project/gatorcoin>";
    const std::string URL_WEBSITE = "<https://gatorcoin.org>";
